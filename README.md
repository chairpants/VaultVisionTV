...
**388 shows** and **~26,000 episodes**. There's no "state" to keep in sync
...
- **Video On Demand** — press `v` to step outside the live simulation
  entirely and browse the full library by genre, show, and season, then play
  and seek any episode on demand.
